                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter your Roll No<span class="required">*</span></label>
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small><button type="button" class="btn btn-primary btn-sm">Copyright © 2020 SRMS</button></small></p>
                    </div>
