...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Student Name<span class="required">*</span></label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Subjects<span class="required">*</span></label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
                                                    </div>
                                                        </div>
